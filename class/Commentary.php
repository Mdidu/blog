<?php
    ...
    class Commentary
    {
         ...
         * @return int
         */
        private function getCommentaryId()
        {
         ...
         * @return string
         */
        private function getContend()
        {
            return $this->contend_commentary;
        }
        ...
        {
            return $this->date_timestamp_commentary;
        }
